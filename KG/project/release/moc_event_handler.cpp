...
QT_MOC_LITERAL(1, 13, 6), // "transX"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 6), // "transY"
QT_MOC_LITERAL(4, 28, 6), // "transZ"
QT_MOC_LITERAL(5, 35, 4) // "draw"

    },
    "EventHandler\0transX\0\0transY\0transZ\0"
    "draw"
};
...
void EventHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transX((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->transY((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->transZ((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->draw((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
